...
Realizar un histograma de la variable `sueldo_bruto`. Usa la función `hist` de R base.

```{r hist-4, exercise=TRUE}
____(kiwi_ar$___________)
```

```{r hist-4-hint-1}
# La función de R base para hacer un histograma se llama hist
# Luego del símbolo $ poné el nombre de la variable sueldo_bruto
```
